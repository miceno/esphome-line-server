...
using esphome::snapcap::RingBuffer;
...
void SnapcapComponent::on_shutdown() {
  for (const Client &client : this->clients_)
    client.socket->shutdown(SHUT_RDWR);
}

void SnapcapComponent::publish_sensor() {
}

void SnapcapComponent::accept() {
...
void SnapcapComponent::send_response(const std::string &response) {
		if (response.empty())
				return;
...
void SnapcapComponent::flush_tcp_buffer() {
    if (!this->tcp_buf_)
        return;
...
bool SnapcapComponent::has_active_clients() const {
...
void SnapcapComponent::motor_open_() {
...
void SnapcapComponent::motor_close_() {
...
void SnapcapComponent::motor_abort_() {
...
void SnapcapComponent::handle_motor_() {
